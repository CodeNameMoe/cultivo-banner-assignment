...
function Banner() {
  ...
  const handleFormSubmitted = (message: any) => {
    console.log(message)
    handleCloseDialog()
  }
  return (
    <div className='relative flex flex-col p-6 bg-[#003E49] rounded-lg text-white max-w-xs font-sans '>
      ...
      <button
        ...
        className='relative z-10 mt-6 py-2 px-4 bg-white text-[#008096] rounded-lg w-full text-sm transition duration-200 ease-in-out hover:bg-[#E1F8FB]'
      >
        Get In Touch
      </button>
      <ContactFormDialog
